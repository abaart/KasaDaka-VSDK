...
urlpatterns = [
    ...
    url(r'^key_input/(?P<element_id>[0-9]+)/(?P<session_id>[0-9]+)$', views.get, name='key-input'),
    url(r'^key_input/(?P<element_id>[0-9]+)/(?P<session_id>[0-9]+)$', views.post, name='key-input-post'),
