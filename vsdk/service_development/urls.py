...
urlpatterns = [
    ...
    url(r'^farmer/register/(?P<session_id>[0-9]+)$', views.Farmer, name = 'farmer-registration'),
    url(r'^advertisement/register/(?P<session_id>[0-9]+)$', views.Advertisement, name = 'advertisement-registration')
]
